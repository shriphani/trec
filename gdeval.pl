...
# Graded relevance assessment script for the TREC 2013 Federated web search track.
# Modified from the original gdeval.pl
...
$MAX_JUDGMENT = 100; # Maximum gain value allowed in qrels file.
